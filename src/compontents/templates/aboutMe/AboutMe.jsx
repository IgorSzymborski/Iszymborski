  ...
  return (
    <section id="aboutme" className={styles.container}>
      ...
      <p className={styles.container__text}>
        Creative and independent Front-End Developer with over a few months
        building stable apps and websites in fast-paced. I am self-taught.{" "}
      </p>
      <p className={styles.container__text}>
      ...
      <p className={styles.container__text}>
        ...
        I also interesting in sports, and more precisely - fights sports.
      </p>
